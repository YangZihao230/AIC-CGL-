...
def build_resnet50(pretrained: str = "./resnet50_miil_21k.pth",
    ...
    backbone = timm.create_model('resnet50', pretrained=True, num_classes=11221, features_only=True, out_indices=[-4, -3, -2, -1])
...
def build_vgg16(pretrained: str = "./vgg16-397923af.pth",
                   return_nodes: Union[dict, None] = None,
                   num_selects: Union[dict, None] = None, 
                   img_size: int = 448,
                   use_fpn: bool = True,
    ...
    backbone = timm.create_model('vgg16', pretrained=True, num_classes=11221, features_only=True, out_indices=[-4, -3, -2, -1])
    ### original pretrained path "./models/vgg16-397923af.pth"
