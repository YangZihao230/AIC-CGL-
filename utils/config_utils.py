...
def get_args(with_deepspeed: bool=False):
    ...
    ### model
    parser.add_argument("--model_name", default="", type=str, help='["resnet50", "swin-t", "vit", "efficient", "vgg16"]')
    ...
    parser.add_argument("--coarse_num_classes", default=10, type=int)
    parser.add_argument("--finegrain", default=False, type=bool)
